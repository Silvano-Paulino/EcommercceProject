...
<head>
    ...
    <style>
        ...
        #categoria input, #categoria button {
            width: 300px;
            height: 50px;
            border-radius: 4px;
        }
    ...
    <div class="container">
        ...
        <main >
            ...
            <section id="categoria">
                ...
                <div>
                    <button onclick="generic_requi('categoria', 'categorias', 'add')">Cadastrar</button>
                </div>
            </section>
            <section id="modifica">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><i class="fa fa-edit"></i> <i class="fa fa-times-circle" onclick="generic_requi('modifica', 'categorias', 'Delete', <?php echo($obj['cod']) ?>)"></i></td>
                        </tr>
                    </tbody>
                </table>
            </section>
