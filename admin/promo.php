...
<head>
    ...
    <link rel="stylesheet" href="../css/ele_produto.css">
    ...
    <style>
        ...
        #precoPromo input, #precoPromo button {
            width: 300px;
            height: 50px;
            border-radius: 4px;
        }
...
<body>
    ...
    <div class="container">
        ...
        <main >
            ...
            <section id="precoPromo">
                <div>
                    <input type="number" name="precoPromo">
                </div>
                <div>
                    <button onclick="generic_requi('precoPromo', 'promocao', 'add')">Cadastrar</button>
                </div>
            </section>
        </main> 
        <!--END OF MAIN-->
