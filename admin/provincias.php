    ...
    <div class="container">
        ...
        <main >
            ...
            <div class="titulo-cadastrar">
                <h2>Cadastrar provincia</h2>
            </div>
            
            <section id="provincia" class="elementar">
                <div>
                ...
                <div>
                    <button onclick="generic_requi('provincia', 'provincia', 'add')">Cadastrar</button>
                </div>
            </section>

            
            <section id="mostrar">
                <h2>Provincias registradas</h2>
                <table>
                    <thead>
                        <th>Id</th>
                        <th>Provincia</th>
                    ...
                    <tbody>
                        <tr>
                            <td><?php echo($obj['cod_provincia']) ?></td>
                            <td><?php echo($obj['provincia_provincia']) ?></td>
                            <td><?php echo($obj['pais_pais']) ?></td>
                            <td><i class="fa fa-edit"></i> <i class="fa fa-times-circle" onclick="generic_requi('mostrar', 'provincia', 'Delete', <?php echo($obj['cod']) ?>)"></i></td>
                        </tr>
                    </tbody>
                </table>
            </section>
